...
public class TimePicker extends LinearLayout implements YearPicker.OnYearSelectedListener,
		MonthPicker.OnMonthSelectedListener, DayPicker.OnDaySelectedListener,HourPiker.OnHourSelectedListener,MinutePiker.OnMinSelectedListener{

	private YearPicker mYearPicker;
	private MonthPicker mMonthPicker;
	private DayPicker mDayPicker;
	private HourPiker mHourPicker;
	private MinutePiker mMinPicker;
...
//		setCurtainBorderColor(curtainBorderColor);
    ...
    private void onDateSelected() {
		if (mOnDateSelectedListener != null) {
			mOnDateSelectedListener.onDateSelected(getYear(),
					getMonth(), getDay(),getHour(),getMinut());
		}
	}
	...
	@Override
	public void onHourselect(int month) {

	}

	@Override
	public void onMinselect(int month) {
