package xxk.wuhai.seacurity.main.view.custorm;
...
public class MyNormalItem extends BaseTabItem {
    ...
    public MyNormalItem(Context context) {
        this(context,null);
    }

    public MyNormalItem(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MyNormalItem(Context context, AttributeSet attrs, int defStyleAttr) {
