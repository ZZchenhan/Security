...
import com.hz.junxinbaoan.work.view.LocationUpdateActivity;
import com.hz.junxinbaoan.work.view.itf.IUpdateLocationView;
...
//        lastMarket = marker;
    ...
    private void search(PoiSearch.Query query){
        ...
        poiSearch.setBound(new PoiSearch.SearchBound(new LatLonPoint(latLng.latitude,latLng.longitude),655355555));
